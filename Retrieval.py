...
from models.model_retrieval import ALBEF                                                                     # 与pretrain引入的不同
...
def main(args, config):
    ...
    model = ALBEF(config=config, text_encoder=args.text_encoder, tokenizer=tokenizer)                                            # 这里的ALBEF与预训练的不是一个ALBEF，就没有init_deit的设置
